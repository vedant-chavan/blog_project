	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Listing <b>Blog</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="{{route('add_blogs')}}" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Add New Employee</span></a>
				...
				<thead>
                    ...
                    @foreach ($blog as $data)
                        <tr>
                            ...
                            <td><image src="{{asset('images/'.$data->image)}}" width="100" height="100"></td>
                        </tr>
                    @endforeach
